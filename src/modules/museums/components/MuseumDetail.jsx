    ...
    return (
        <div className="max-w-4xl m-auto w-full bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="my-4 flex flex-wrap gap-2">
                <Link
                    className="bg-indigo-100 text-indigo-700 hover:bg-indigo-300 py-2 px-4 rounded flex items-center"
                    to="/museums"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                ...
                <Link
                    ...
                    className="bg-purple-100 text-purple-800 py-2 px-4 rounded-md hover:bg-purple-200 transition duration-200 flex items-center"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd" />
                    </svg>
